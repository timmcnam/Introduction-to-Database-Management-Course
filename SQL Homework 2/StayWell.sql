...
CREATE TABLE PROPERTY (
    ...
    CONSTRAINT property_officeNum_fk FOREIGN KEY(OFFICE_NUM) references office(OFFICE_NUM),
    CONSTRAINT property_owner_Num_fk FOREIGN KEY(OWNER_NUM) references owner(OWNER_NUM)
...
CREATE TABLE SERVICE_REQUEST (
    ...
    CONSTRAINT SR_propertyId_fk FOREIGN KEY(PROPERTY_ID) references property(PROPERTY_ID),
    CONSTRAINT SR_officeId_fk FOREIGN KEY(OFFICE_ID) references office(OFFICE_NUM),
    CONSTRAINT SR_categoryNum_fk FOREIGN KEY(CATEGORY_NUMBER) references SERVICE_CATEGORY(CATEGORY_NUM)
...
CREATE TABLE RESIDENTS (
    ...
    PROPERTY_ID SMALLINT NOT NULL,
    CONSTRAINT residents_propertyId_fk FOREIGN KEY(PROPERTY_ID) references property(PROPERTY_ID)
...
SELECT * FROM information_schema.table_constraints where TABLE_SCHEMA= 'StayWell';

DESC OFFICE;
DESC SERVICE_CATEGORY;
