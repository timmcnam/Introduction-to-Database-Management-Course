...
POSTAL_CODE CHAR(5),
PHONE CHAR(12),
CONSTRAINT customer_custNum_pk PRIMARY KEY(CUSTOMER_NUM) );
...
CUSTOMER_NUM CHAR(4),
CONSTRAINT reservation_resrvID_pk PRIMARY KEY(RESERVATION_ID),
...
SELECT * FROM information_schema.table_constraints where TABLE_SCHEMA='ColonialAdventureTours';
...
#####	END PART 4	#####
#####	THIS CONCLUDES HOMEWORK-1 FOR MYSQL	#####alter
