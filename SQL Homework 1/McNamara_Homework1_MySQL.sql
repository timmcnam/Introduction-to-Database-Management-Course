...
#create summer school rentals table - part 1
create table SUMMER_SCHOOL_RENTALS
(
PROPERTY_ID smallint(2) not null,
OFFICE_NUM smallint(2) not null,
ADDRESS char(25) not null,
SQR_FT decimal(5) not null,
BDRMS decimal(2) not null,
FLOORS decimal(2) not null,
WEEKLY_RENT decimal(6,2) not null,
OWNER_NUM char(5) not null,
constraint property_id_pk primary key(PROPERTY_ID)
);

#insert values - part 1
Insert Into SUMMER_SCHOOL_RENTALS
Values
('13','1','5857 Goodwin Ave','1650','2','1',400.00,'C0103');

show tables;
select * from SUMMER_SCHOOL_RENTALS;

drop table SUMMER_SCHOOL_RENTALS;

#Create six tables in staywell database - part 2
use StayWell;
...
constraint owner_num_pk primary key (owner_num)
);

#inserting the data - part 3
INSERT INTO OWNER 
VALUES
...
constraint property_off_num_fk 
foreign key (OFFICE_NUM) references OFFICE (OFFICE_NUM),
constraint property_own_num_fk
...
INSERT INTO OFFICE 
VALUES
('1','StayWell-Colombia City','1135 N. Wells Avenue','Colombia City','Seattle','WA','98118');
INSERT INTO OFFICE 
VALUES
('2','StayWell-Georgetown','986 S. Madison Rd','Georgetown','Seattle','WA','98108');

# Create SERVICE_CATEGORY table - part 2
DROP TABLE IF EXISTS SERVICE_CATEGORY;
CREATE TABLE SERVICE_CATEGORY 
(
    CATEGORY_NUM TINYINT PRIMARY KEY NOT NULL,
    CATEGORY_DESCRIPTION VARCHAR(100) NOT NULL,
constraint service_category_num_pk primary key (CATEGORY_NUM)
);
...
# Create SERVICE_REQUEST table - part 2  
...
constraint service_request_id_pk
primary key (SERVICE_ID),
constraint service_property_id_fk
foreign key (PROPERTY_ID) references PROPERTY (PROPERTY_ID),
constraint service_category_number_fk
...
INSERT INTO SERVICE_REQUEST 
VALUES
('2','1','4','1','A new strip light is needed for the kitchen.','Scheduled','1','0','2019-10-2');
INSERT INTO SERVICE_REQUEST 
VALUES
...
(
    ...
    constraint resident_property_id_fk 
    foreign key(PROPERTY_ID) references PROPERTY (PROPERTY_ID)
);
